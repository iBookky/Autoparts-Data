...
async def global_exception_handler(request: Request, exc: Exception):
    ...
    return JSONResponse(
        status_code=500,
        content={"success": False, "error": str(exc), "traceback": traceback.format_exc()}
    )
...
async def get_public_platform_settings():
    ...
    return {
        ...
        "settings": {
            ...
            "site_title_th": settings.get("site_title_th") or settings.get("site_title", "AutoParts Cross-Ref - ระบบเทียบเบอร์อะไหล่และสืบค้น OEM"),
            "site_title_en": settings.get("site_title_en") or settings.get("site_title", "AutoParts Cross-Ref - B2B Automotive Intelligence"),
            "logo_url": settings.get("logo_url", ""),
            "favicon_url": settings.get("favicon_url", ""),
            "primary_color": settings.get("primary_color", "#3B82F6"),
            "navbar_bg_color": settings.get("navbar_bg_color", ""),
            "navbar_style": settings.get("navbar_style", "default"),
            "hero_badge": settings.get("hero_badge", "แพลตฟอร์มสืบค้นและเทียบรหัสอะไหล่รถยนต์อันดับ 1 ในไทย"),
            "hero_badge_th": settings.get("hero_badge_th") or settings.get("hero_badge", "แพลตฟอร์มสืบค้นและเทียบรหัสอะไหล่รถยนต์อันดับ 1 ในไทย"),
            "hero_badge_en": settings.get("hero_badge_en") or settings.get("hero_badge", "#1 Automotive Parts Cross-Reference Platform in Thailand"),
            "hero_title": settings.get("hero_title", "เทียบเบอร์อะไหล่แท้ & อะไหล่ทดแทน"),
            "hero_title_th": settings.get("hero_title_th") or settings.get("hero_title", "เทียบเบอร์อะไหล่แท้ & อะไหล่ทดแทน"),
            "hero_title_en": settings.get("hero_title_en") or settings.get("hero_title", "OEM vs Aftermarket Cross-Reference System"),
            "hero_subtitle": settings.get("hero_subtitle", "ค้นหาข้ามแบรนด์ แม่นยำ รวดเร็ว พร้อมเชื่อมต่อระบบ AI และสต็อกสินค้าอัจฉริยะ"),
            "hero_subtitle_th": settings.get("hero_subtitle_th") or settings.get("hero_subtitle", "ค้นหาข้ามแบรนด์ แม่นยำ รวดเร็ว พร้อมเชื่อมต่อระบบ AI และสต็อกสินค้าอัจฉริยะ"),
            "hero_subtitle_en": settings.get("hero_subtitle_en") or settings.get("hero_subtitle", "Search across 8+ aftermarket brands, VIN decoder, and instant AI compatibility check."),
            ...
            "seo_meta_title_th": settings.get("seo_meta_title_th") or settings.get("seo_meta_title", "AutoParts Cross-Ref | ระบบเทียบเบอร์อะไหล่และค้นหาด้วย VIN"),
            "seo_meta_title_en": settings.get("seo_meta_title_en") or settings.get("seo_meta_title", "AutoParts Cross-Ref | OEM & Aftermarket Parts Intelligence"),
            ...
            "seo_meta_description_th": settings.get("seo_meta_description_th") or settings.get("seo_meta_description", "แพลตฟอร์มค้นหาและเทียบเคียงรหัสอะไหล่แท้และอะไหล่ทดแทน (OEM & Aftermarket) ที่ใหญ่ที่สุดในประเทศไทย"),
            "seo_meta_description_en": settings.get("seo_meta_description_en") or settings.get("seo_meta_description", "The largest OEM and aftermarket automotive cross-reference platform in Thailand."),
            "seo_meta_keywords": settings.get("seo_meta_keywords", "อะไหล่รถยนต์, เทียบเบอร์อะไหล่, OEM parts, Aftermarket, VIN decoder"),
            "seo_meta_keywords_th": settings.get("seo_meta_keywords_th") or settings.get("seo_meta_keywords", "อะไหล่รถยนต์, เทียบเบอร์อะไหล่, OEM parts, Aftermarket, VIN decoder"),
            "seo_meta_keywords_en": settings.get("seo_meta_keywords_en") or settings.get("seo_meta_keywords", "auto parts, cross reference, OEM parts, aftermarket, VIN decoder"),
            ...
            "footer_copyright_th": settings.get("footer_copyright_th") or settings.get("footer_copyright", "© 2026 AutoParts Cross-Ref. สงวนลิขสิทธิ์ทุกประการ"),
            "footer_copyright_en": settings.get("footer_copyright_en") or settings.get("footer_copyright", "© 2026 AutoParts Cross-Ref. All rights reserved."),
...
async def get_owner_branding_settings(user = Depends(require_owner)):
    ...
    return {
        ...
        "branding": {
            ...
            "site_title_th": settings.get("site_title_th") or settings.get("site_title", ""),
            "site_title_en": settings.get("site_title_en") or settings.get("site_title", ""),
            "logo_url": settings.get("logo_url", ""),
            "favicon_url": settings.get("favicon_url", ""),
            "primary_color": settings.get("primary_color", "#3B82F6"),
            "navbar_bg_color": settings.get("navbar_bg_color", ""),
            ...
            "hero_badge_th": settings.get("hero_badge_th") or settings.get("hero_badge", ""),
            "hero_badge_en": settings.get("hero_badge_en") or settings.get("hero_badge", ""),
            "hero_title": settings.get("hero_title", ""),
            "hero_title_th": settings.get("hero_title_th") or settings.get("hero_title", ""),
            "hero_title_en": settings.get("hero_title_en") or settings.get("hero_title", ""),
            "hero_subtitle": settings.get("hero_subtitle", ""),
            "hero_subtitle_th": settings.get("hero_subtitle_th") or settings.get("hero_subtitle", ""),
            "hero_subtitle_en": settings.get("hero_subtitle_en") or settings.get("hero_subtitle", ""),
            "hero_bg_style": settings.get("hero_bg_style", "gradient"),
            "hero_bg_color": settings.get("hero_bg_color", "#0B132B"),
            "hero_bg_gradient": settings.get("hero_bg_gradient", ""),
            "seo_meta_title": settings.get("seo_meta_title", ""),
            "seo_meta_title_th": settings.get("seo_meta_title_th") or settings.get("seo_meta_title", ""),
            "seo_meta_title_en": settings.get("seo_meta_title_en") or settings.get("seo_meta_title", ""),
            "seo_meta_description": settings.get("seo_meta_description", ""),
            "seo_meta_description_th": settings.get("seo_meta_description_th") or settings.get("seo_meta_description", ""),
            "seo_meta_description_en": settings.get("seo_meta_description_en") or settings.get("seo_meta_description", ""),
            "seo_meta_keywords": settings.get("seo_meta_keywords", ""),
            "seo_meta_keywords_th": settings.get("seo_meta_keywords_th") or settings.get("seo_meta_keywords", ""),
            "seo_meta_keywords_en": settings.get("seo_meta_keywords_en") or settings.get("seo_meta_keywords", ""),
            ...
            "footer_copyright_th": settings.get("footer_copyright_th") or settings.get("footer_copyright", ""),
            "footer_copyright_en": settings.get("footer_copyright_en") or settings.get("footer_copyright", "")
        }
    }
