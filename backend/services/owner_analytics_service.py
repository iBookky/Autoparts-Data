    ...
    def get_customers_analytics(cls) -> Dict[str, Any]:
        ...
        cursor.execute("""
            SELECT o.id, o.name, o.slug, o.plan_tier, o.created_at, o.legal_name, o.tax_id, o.billing_email,
                   o.phone, o.address, o.contact_person, o.business_type, o.industry,
        ...
        for r in org_rows:
            ...
            customers.append({
                ...
                "tax_id": r["tax_id"] or "",
                "contact_name": r["contact_person"] or "",
                "contact_person": r["contact_person"] or "",
                "email": r["billing_email"] or "",
                "billing_email": r["billing_email"] or "",
                "phone": r["phone"] or "",
                "billing_address": r["address"] or "",
                "address": r["address"] or "",
                "business_type": r["business_type"] or "GARAGE",
                "industry_type": r["industry"] or r["business_type"] or "GARAGE",
